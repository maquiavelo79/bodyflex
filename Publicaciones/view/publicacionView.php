...
<head>
	...
	<!-- Basic Page Needs================ -->
            <meta charset="utf-8">
            <title>Bodyflex - Publicación</title>
...
<body>
    <!-- start: Header -->
    <?php include("../../../bodyflex/Publicaciones/modulos/header.php"); ?>
    <!-- start: Header -->
    ...
    <?php include("../../../bodyflex/Publicaciones/modulos/footer.php"); ?>
    <!-- start: JavaScript-->
        <?php include("../../../bodyflex/Publicaciones/modulos/javaScript.php"); ?>
