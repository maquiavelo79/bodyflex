...
$tIpo='';
    ...
    try{
        ...
        if($conn){
            ...
            $sql = 'CALL SP_CP_ADM_CSU_PRO_VIT(:sw, :ultimo, @codErr)';
            ...
            if($num>0){
                ...
                while ($r = $stmt->fetch(PDO::FETCH_NUM)):
                    ...
                    $sTr = '<tr style="cursor:pointer;">';
                        ...
                        $sTr.='<td class="center" style="display: none;">' . $pEti  . '</td>';
                ...
                $paginacion.='<ul>';
                    for($i=1;$i<=$pag;$i++){
                        ...
                        if($pa==$i){
                            ...
                            $paginacion.='<li style="cursor:pointer;"><a onclick="muestraProductoVitrina(0,' . $ultimos[$j] . ',' . $i . ')">' . $i . '</a></li>';
                        }
                    }
                $paginacion.='</ul>';
