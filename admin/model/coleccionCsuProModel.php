...
include("../model/conection.php");
    ...
    try{
        ...
        if($conn){    
            ...
            $sql="CALL SP_CP_ADM_CSU_PRO_COL_RSM(:coleccion, @codErr, @total);";
            ...
            if($num>0){
                while ($r = $stmt->fetch(PDO::FETCH_NUM)): 
                    ...
                    $sTr.='<div class="productos">';
                        $sTr.='<span class="fa-stack fa-3x">';
                          $sTr.='<i class="fa fa-comment fa-stack-2x" style="color: #FFCC00;;"></i>';
                ...
                $rsm.='<span class="proCol" style="font-size: 16px; font-weight: bold; cursor: pointer; color: blue;"><i><u>['.$total.'] Productos Colecci&oacute;n</u></i></span>';
                ...
                switch($codErr){
                    ...
                    case 99:
                        ...
                        break;
                    case 98:
                        $desErr='COLECCIÓN SIN PRODUCTOS';
                        break;
                }
            }        
        }else{
