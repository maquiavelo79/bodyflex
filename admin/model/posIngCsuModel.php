...
include("../model/conection.php");
    ...
    try{
        ...
        if($conn){   
            ...
            $sql="CALL SP_CP_ADM_CSU_POS_ING(:sw, :ultimo, @codErr);";
            ...
            if($num>0){
                ...
                while ($r = $stmt->fetch(PDO::FETCH_NUM)):
                    ...
                    $sTr = '<tr style="cursor:pointer;">';
                        ...
                        $sTr.='<td>' . $posFec . '</td>';
                        $sTr.='<td class="center">';
                            $sTr.='<span id='.$posId.' email='.$posEma.' nom='.$posNom.' ape='.$posApe.' style="text-align: center; font-weight: bold; color: #white; cursor: pointer;" class="label label-success">EVALUAR</span>';
                        $sTr.='</td>';    
                    $sTr.='</tr>';
