...
$tIpo='';
    ...
    try{
        ...
        if($conn){
            ...
            $sql = 'CALL SP_CP_ADM_CONSULTA_CATEGORIAS_PRODUCTOS(:nivelCat, :nivelCod, @codErr)';
                ...
                switch($nivelCat){
                    case 1:
                        ...
                        $cmb.='<div class="controls">';					
                            $cmb.='<select id="cmbCat1" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; text-align: center;" onchange="getSubCat(2, this.value, 0);" style="text-align: center; color: black;">';
                                $cmb.='<option value="0" selected="">(SELECCIONE)</option>';  
                                $cmb.=$sTrR;
                            $cmb.='</select>';
                            $cmb.='<span id="icoCat1" style="display:none;" class="help-inline"><i style="color: red;"class="fa fa-times fa-2x"></i></span>';
                        $cmb.='</div>';
                        break;
                    ...
                    case 2:
                        ...
                        $cmb.='<div class="controls">';					
                            $cmb.='<select id="cmbCat2" onchange="getSubCat(3, this.value, 0);" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; text-align: center;">';
                                ...
                                $cmb.=$sTrR;
                            $cmb.='</select>';
                            $cmb.='<span id="icoCat2" style="display:none;" class="help-inline"><i style="color: red;"class="fa fa-times fa-2x"></i></span>';
                        $cmb.='</div>';
                        break;
                    ...
                    case 3:  
                        ...
                        $cmb.='<div class="controls">';					
                            $cmb.='<select id="cmbCat3" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; text-align: center;">';
                                ...
                                $cmb.=$sTrR;
                            $cmb.='</select>';
                            $cmb.='<span id="icoCat3" style="display:none;" class="help-inline"><i style="color: red;"class="fa fa-times fa-2x"></i></span>';
                        $cmb.='</div>';
                        break;
