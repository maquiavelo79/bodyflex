...
<head>
	...
	<!-- Basic Page Needs================ -->
            <meta charset="utf-8">
            <title>Bodyflex - Producto Categor&iacute;a 2</title>
            ...
            <script type="text/javascript">
                $(document).ready(function (){
                    ...
                    document.querySelector('button#modalVerImagen').onclick = function(){
                        ...
                        var url='';
                        url='http://drive.google.com/uc?export=view&id='+$("#txtCat2GD").val().trim();
                    ...
                    document.querySelector('button#modalVerImagen2').onclick = function(){
                        ...
                        var url='';
                        url='http://drive.google.com/uc?export=view&id='+$("#txtCat2GD2").val().trim();
                        var parametros = {"url" : url};      
...
<body>
                ...
                <div id="content" class="span10">
                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                                <div class="box-header" data-original-title>
                                    <h2><i class="halflings-icon edit"></i><span class="break"></span>Producto: Segunda Categor&iacute;a</h2>
                                    <div class="box-icon">
                                    ...
                                    <form class="form-horizontal" id="formSlider">
                                        <fieldset>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div>
                                                        <input id="txtCat2Id" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; width: 200px; text-align: center; color: black;" size="30" type="text" maxlength="10" disabled  value="">
                                                    </div>
                                                </div>
                                            </div> 
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="input-append">
                                                          <input id="txtCat2Nom" placeholder="Ingrese nombre categoría" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; width: 490px; text-align: center; color: black;"  size="30" type="text" maxlength="100">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input id="txtCat2GD" placeholder="ID Imagen 850 x 300" size="16" type="text" maxlength="50" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; width: 300px; text-align: center; color: black;">
                                                    <span id="sVerImg" class="help-inline sVerImg">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label" for="appendedInput"><b>Id Google Drive</b></label>
                                                <div class="controls">
                                                    <input id="txtCat2GD2" placeholder="ID Imagen 217 x 217" size="16" type="text" maxlength="50" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; width: 300px; text-align: center; color: black;">
                                                    <span id="sVerImg2" class="help-inline sVerImg">
                                                        <i class="fa fa-picture-o fa-2x"></i>
                                                    </span>
                                                </div>
                                            </div>
                    ...
                    <div id="divConCat2" class="row-fluid sortable">		
                        <div class="box span12">
                            ...
                            <div id="divTblCat2" class="box-content">
                                <input id="cantCat2" type="hidden" value=0>
                                <table id="tblCat2" class="table table-striped table-bordered bootstrap-datatable">
                                    <thead id="thead">
                                        <tr>
    ...
    <script src="../controller/categoria2Controller.js"></script>
