...
<head>
	...
	<!-- Basic Page Needs================ -->
            <meta charset="utf-8">
            <title>Bodyflex - [ADM] Colores</title>
...
<body>
        ...
        <div class="row-fluid">
            ...
            <!-- start: Content -->
                <div id="content" class="span10">
                    ...
                    <div style="height: 50px; display:none;" id="espera"></div><br>
                    <div id="colWarning1" style="display:none;" class="box-content alerts"></div>
                                        
                    <div id="divColores" style="display:none;" class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="halflings-icon edit"></i><span class="break"></span>Colores Producto</h2>
                                <div class="box-icon">
                                    <a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
                                </div>
                            </div>
                            <br>
                            <div class="box-content" style="margin-left: 160px;">
                                <form class="form-horizontal">
                                    <fieldset>
                                        <div id="color">   
                                            <input type="hidden" id="codCol">
                                            <div style="margin-right: 20px;" class="input-append">
                                                <label style="margin-right: 10px;" class="control-label" for="selectError"><b>Color</b></label>
                                                <input id="proCol" name="proRut" style="box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; height: 15px; text-align: center; color: black; font-weight: bold; background-color: whitesmoke; font-size: 14px; text-align: center; color: black; width: 180px;" type="text" maxlength="100">
                                            </div>
                                            <div class="input-append">
                                                <label style="margin-right: 10px;" class="control-label" for="selectError"><b>background-color (CSS)</b></label>
                                                <input id="proBac" name="proRut" style="box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; height: 15px; text-align: center; color: black; font-weight: bold; background-color: whitesmoke; font-size: 14px; text-align: center; color: black; width: 180px;" type="text" maxlength="100">
                                            </div>
                                        </div>
                                    </fieldset>
                                </form>
                    ...
                    <div style="height: 50px; display:none;" id="espera2"></div>
                    <div id="colWarning2" style="display: none;" class="box-content alerts"></div>
                    ...
                    <div id="divColTbl" style="display: none;" class="box-content">
                        <table id="tblColores" class="table table-bordered table-striped table-condensed">
                            <thead>
                                <tr>
                                    <th>Identificador</th>
                                    <th>Color</th>
                         ...
                         <div style="height: 50px; display: none;" id="espera3"></div>
    ...
    <script src="../controller/regProColController.js"></script>
