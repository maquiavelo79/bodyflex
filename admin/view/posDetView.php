...
<head>
	...
	<!-- Basic Page Needs================ -->
            <meta charset="utf-8">
            <title>Bodyflex - [ADM] Ingresadas</title>
                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                                <div class="box-header" data-original-title>
                                    <h2><i class="halflings-icon edit"></i><span class="break"></span>Postulaciones <b>detenidas</b></h2>
                                    <div class="box-icon">
...
<!--    <div style="text-align:center;" class="alert alert-error">
    ...
    <script src="../controller/posDetController.js"></script>
