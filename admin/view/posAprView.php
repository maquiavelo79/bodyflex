...
<head>
	...
	<!-- Basic Page Needs================ -->
            <meta charset="utf-8">
            <title>Bodyflex - [ADM] Aprobaci&oacute;n Postulaci&oacute;n</title>
            ...
            <!-- start: Content -->
                <div id="content" class="span10">
                    ...
                    <div class="box-content">
                        <table id="tbl1" class="table table-bordered table-striped table-condensed">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Nombre</th>
                        ...
                        <table id="tbl2" style="display: none;" class="table table-bordered table-striped table-condensed">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Nombre</th>
                                    ...
                                    <th>Email</th>    
                                    <th>Fecha</th>    
                                    <th>ID directorio Google Drive</th> 
                                </tr>
                            </thead>   
...
<!--    <input style="box-shadow: 0 0 6px black; margin: 0px 0px 0px 0px; width: 280px; height: 15px; text-align: center; color: black; font-weight: bold; background-color: papayawhip;" placeholder="ej: 0B82UUH1gaEMAb3hieEgwckxPMEE" size="16" type="text" maxlength="200">-->
    
<!--    &nbsp; <span style="font-size: 10px; padding: 3px 3px; width: 60px; text-align: center; font-weight: bold; color: white; cursor: pointer;" class="label label-inverse">APROBADA</span>-->
...
<!--        <span id='a' style="background-color: #FFCC00; text-align: center; font-weight: bold; color: black; cursor: pointer;" class="label label-warning">DETENER</span>
        ...
        <span id='a' class="btn btn-small btn-danger">RECHAZAR</span>-->
...
<!--    <div style="text-align:center;" class="alert alert-error">
    ...
    <script src="../controller/posAprController.js"></script>
