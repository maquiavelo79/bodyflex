...
<head>
	...
	<!-- Basic Page Needs================ -->
            <meta charset="utf-8">
            <title>Bodyflex - Producto Categor&iacute;a 3</title>
            ...
            <script type="text/javascript">
                $(document).ready(function (){
                    ...
                    document.querySelector('button#modalVerImagen').onclick = function(){
                        ...
                        var url='';
                        url='http://drive.google.com/uc?export=view&id='+$("#txtCat3GD").val().trim();
                        var parametros = {"url" : url};      
                        
                        //alert('modalVerImagen ' + url);
                    ...
                    document.querySelector('button#modalVerImagen2').onclick = function(){
                        ...
                        var url2='';
                        url2='http://drive.google.com/uc?export=view&id='+$("#txtCat3GD2").val().trim();
                        var parametros = {"url" : url2};      
                        
                        //alert('modalVerImagen2 ' + url2);
...
<body>
                ...
                <div id="content" class="span10">
                                    ...
                                    <form class="form-horizontal" id="formSlider">
                                        <fieldset>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div>
                                                        <input id="txtCat3Id" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; width: 200px; text-align: center; color: black;" size="30" type="text" maxlength="10" disabled  value="">
                                                    </div>
                                                </div>
                                            </div> 
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="input-append">
                                                          <input id="txtCat3Nom" placeholder="Ingrese nombre categoría" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; width: 490px; text-align: center; color: black;"  size="30" type="text" maxlength="100">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input id="txtCat3GD" placeholder="ID Imagen 850 x 300" size="16" type="text" maxlength="200" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; width: 300px; text-align: center; color: black;">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label" for="appendedInput"><b>Id Google Drive</b></label>
                                                <div class="controls">
                                                    <input id="txtCat3GD2" placeholder="ID Imagen 217 x 217" size="16" type="text" maxlength="50" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; width: 300px; text-align: center; color: black;">
                    ...
                    <div id="divConCat2" class="row-fluid sortable">		
                        <div class="box span12">
                            ...
                            <div id="divTblCat3" class="box-content">
                                <input id="cantCat3" type="hidden" value=0>
                                <table id="tblCat3" class="table table-striped table-bordered bootstrap-datatable">
                                    <thead id="thead">
                                        <tr>
                                            <th class="center">cat1ID</th>
                                            <th class="center">cat1Nom</th>
                                            <th class="center">cat2ID</th>
                                            <th class="center">cat2Nom</th>
                                            <th class="center">cat3ID</th>
                                            <th class="center">cat3Nom</th>
    ...
    <script src="../controller/categoria3Controller.js"></script>
