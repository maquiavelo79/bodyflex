...
<head>
	...
	<!-- Basic Page Needs================ -->
            <meta charset="utf-8">
            <title>Bodyflex - Producto Categor&iacute;a 1</title>
            ...
            <script type="text/javascript">
                $(document).ready(function (){
                    ...
                    document.querySelector('button#modalVerImagen').onclick = function(){
                        ...
                        var url='';
                        url='http://drive.google.com/uc?export=view&id='+$("#txtCat1GD").val().trim();
...
<body>
                ...
                <div id="content" class="span10">
                                    ...
                                    <form class="form-horizontal" id="formSlider">
                                        <fieldset>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div>
                                                        <input id="txtCat1Id" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; width: 200px; text-align: center; color: black;" size="30" type="text" maxlength="10" disabled  value="">
                                                    </div>
                                                </div>
                                            </div> 
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="input-append">
                                                          <input id="txtCat1Nom" placeholder="Ingrese nombre categoría" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; width: 490px; text-align: center; color: black;"  size="30" type="text" maxlength="100">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input id="txtCat1GD" placeholder="ID Imagen 850 x 300" size="16" type="text" maxlength="50" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; width: 300px; text-align: center; color: black;">
                    ...
                    <div class="row-fluid sortable">		
                        <div class="box span12">
                            ...
                            <div class="box-content">
                                <input id="cantCat1" type="hidden" value=0>
                                <table id="tblCat1" class="table table-striped table-bordered bootstrap-datatable">
                                    <thead>
                                        <tr>
    ...
    <script src="../controller/categoria1Controller.js"></script>
