...
<head>
	...
	<!-- Basic Page Needs================ -->
            <meta charset="utf-8">
            <title>Bodyflex - [ADM] Vitrina</title>
            ...
            <!-- start: Content -->
                <div id="content" class="span10">
                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            ...
                            <div class="box-content">
                                ...
                                <div style="display: none;" class="form-actions" id="botonera">
                    ...
                    <div class="row-fluid sortable">		
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="halflings-icon edit"></i><span class="break"></span>Productos en Vitrina</h2>
                                <div class="box-icon">
                                    <a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
                                </div>
                            </div>
                            <div class="box-content" id="conTabla"><!--contenedor de tabla -->
                                <table id="tblProVit" class="table table-striped table-bordered bootstrap-datatable"> <!-- -->
                                    <thead>
                                        <tr>
                                            <th>Id</th>
                                            <th>Nombre</th>
...
<!--                                            <th>Etiqueta</th>-->
    ...
    <script src="../controller/proVitController.js"></script>
