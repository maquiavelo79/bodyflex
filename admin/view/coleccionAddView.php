...
<head>
	...
	<!-- Basic Page Needs================ -->
            <meta charset="utf-8">
            <title>Bodyflex - Producto Colecci&oacute;n</title>
            ...
            <script type="text/javascript">
                $(document).ready(function (){
                    ...
                    document.querySelector('button#modalVerImagen').onclick = function(){
                        ...
                        var url='';
                        url='http://drive.google.com/uc?export=view&id='+$("#txtProGD").val().trim();
            ...
            <!-- start: Content -->
                <div id="content" class="span10">
                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                                <div class="box-header" data-original-title>
                                    <h2><i class="halflings-icon edit"></i><span class="break"></span>1° Seleccione producto para la colecci&oacute;n </h2>
                                    <div class="box-icon">
                                    ...
                                    <form class="form-horizontal" id="formSlider">
                                        <fieldset>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div>
                                                        <input id="txtProId" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-size: 18px; font-weight: bold; color: black; width: 160px; text-align: center;" size="30" type="text" maxlength="10" value="">
                                                        &nbsp; <i id="btnBsq" class="fa fa-search-plus fa-2x" style="cursor: pointer;"></i>
                                                    </div>
                                                </div>
                                            </div> 
                                            
                                            <div class="control-group">
                                                <label class="control-label" for="selectError"><b>Categor&iacute;a 1</b></label>
                                                <div id="divCat1" class="controls">
                                                    <select id="cmbCat1" data-rel="chosen">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label" for="selectError"><b>Categor&iacute;a 2</b></label>
                                                <div id="divCat2" class="controls">
                                                    <select id="cmbCat2" data-rel="chosen">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label" for="selectError"><b>Categor&iacute;a 3</b></label>
                                                <div id="divCat3" class="controls">
                                                    <select id="cmbCat3" data-rel="chosen">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="input-append">
                                                          <input id="txtProNom" disabled placeholder="Ingrese nombre categoría" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; width: 490px; text-align: center; color: black;"  size="30" type="text" maxlength="100">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input id="txtProGD" disabled placeholder="ID Imagen 850 x 300" size="16" type="text" maxlength="200" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; width: 300px; text-align: center; color: black;">
                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="halflings-icon edit"></i><span class="break"></span>2° Colecciones</h2>
                                <div class="box-icon">
                                    <a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
                                </div>
                            </div>
                                ...
                                <form class="form-horizontal">
                                    <div class="control-group">
                                        <div class="controls" style="margin-left: 250px;">
                                            <select id="cmbCol" multiple data-rel="chosen" style="width: 500px;"></select>
                                        </div>
                                    </div>
                                </form>
                            </div>    
...
<!--                    <div id="warning" style="display: block; margin-top: 10px;" class="box-content alerts">
                        <div style="text-align:center;" class="alert alert-success">
                            <b><span style="color: black;">Producto Agregado a la Colección</span></b>
                        </div>
                    </div>
                    <div id="warning" style="display: block; margin-top: 10px;" class="box-content alerts">
                        <div style="text-align:center;" class="alert alert-block">
                            <b><span style="color: black;">Producto Eliminado de la Colección</span></b>
                        </div>
                    </div>-->
                    ...
                    <div id="divConCat2" class="row-fluid sortable">		
                        <div class="box span12">
                            ...
                            <div id="divTblCat3">
                                <input id="cantCat3" type="hidden" value=0>
                                <table id="tblPro" class="table table-striped table-bordered bootstrap-datatable">
                                    <thead id="thead">
                                        <tr>
    ...
    <script src="../controller/coleccionAddController.js"></script>
    ...
    <!--
    <input type="hidden" id="nomCol" value= "">
    <input type="hidden" id="codCol" value= "">
    <input type="hidden" id="idPrId" value= "">
    -->
