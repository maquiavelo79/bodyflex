    ...
    <div class="box span12">
        ...
        <div class="box-content" style="height: 50px;">
            <table class="table">
                <tr>
                    <td class="center">
                        <span class="input-xlarge uneditable-input" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; width:185px; text-align: center;"><?= $_SESSION['rut'];?>&nbsp;-&nbsp;<?= $_SESSION['dv'];?></span>
                    </td>
                    <td class="center">
                        <span class="input-xlarge uneditable-input" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; width:185px; text-align: center;"><?= $_SESSION['nombre'];?></span>
                    </td>
                    <td class="center">
                        <span class="input-xlarge uneditable-input" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; width:185px; text-align: center;"><?= $_SESSION['apellido'];?></span>
                    </td>
                    <td class="center">
                        <span class="input-xlarge uneditable-input" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; width:185px; text-align: center;"><?= $_SESSION['rol'];?></span>
                    </td>                                 
                    <td class="center">
                        <span class="input-xlarge uneditable-input" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; width:185px; text-align: center;"><?= $_SESSION['alias'];?></span>
                    </td>
                    <td class="center">
