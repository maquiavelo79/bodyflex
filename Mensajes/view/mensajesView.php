...
<body>
    <!-- start: Header -->
        <?php include("../../../bodyflex/Mensajes/modulos/header.php"); ?>
    <!-- start: Header -->
    ...
    <div class="container-fluid-full">
        <div class="row-fluid">
            ...
            <div id="content" class="span10">		
                <!-- start: navegación-->
                <?php include("../../../bodyflex/Mensajes/modulos/navegacion.php"); ?>
                <!-- end: navegación -->
                
                <!-- HEADER -->
                    <?php include("../../../bodyflex/Mensajes/modulos/headerUser.php"); ?>
                    <br>
                <!-- HEADER -->
                
                <div class="row-fluid">	
                    <?php include("../../../bodyflex/Mensajes/modulos/mensajesLista.php"); ?>
                    <?php include("../../../bodyflex/Mensajes/modulos/mensajesDetalle.php"); ?>
                </div>
    ...
    <?php include("../../../bodyflex/Mensajes/modulos/footer.php"); ?>
    <?php include("../../../bodyflex/Mensajes/modulos/javaScript.php"); ?>
