...
<head>
	...
	<!-- Basic Page Needs================ -->
            <meta charset="utf-8">
            <title>Bodyflex - CPANEL [COM]</title>
...
<body>
        <!-- start: Header -->
	<?php include("../comp/modulos/header.php"); ?>
	<!-- start: Header -->
        <div class="container-fluid-full">
            <div class="row-fluid">
                <?php include("../comp/modulos/menu.php"); ?>
                <noscript>
                ...
                <div id="content" class="span10">	
                    <?php include("../comp/modulos/navegacion.php"); ?>
                    <?php include("../comp/modulos/indicadoresRectangular4.php"); ?>	
                    <?php include("../comp/modulos/histogramas2.php"); ?>    
                    <?php include("../comp/modulos/indicadoresCirculares6.php"); ?>    
                    <?php include("../comp/modulos/histogramas3.php"); ?>  
                    <?php include("../comp/modulos/eventos3.php"); ?>	
                    <?php include("../comp/modulos/indicadoresCuadrados6.php"); ?>                            
                </div>
            </div><!--/#content.span10-->
        </div><!--/fluid-row-->
	...
	<!-- start: JavaScript-->
            ...
            <?php include("../comp/modulos/javaScript.php"); ?>
	<!-- end: JavaScript-->
