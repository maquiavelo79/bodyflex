...
<div class="span7">
    ...
    <!-- DATOS DEL REGISTRO SELECCIONADO-->
        ...
        <input type="hidden" id="fec" value=""><br>  
        <input type="hidden" id="lei" value=""><br>   
        <input type="hidden" id="tip" value=""><br>  
        <input type="hidden" id="cor" value=""><br>  
        <input type="hidden" id="key" value=""><br>  
        <input type="hidden" id="msg" value=""><br>  
        <input type="hidden" id="asu" value=""><br>  
        <input type="hidden" id="ali" value=""><br>  
        <input type="hidden" id="mai" value=""><br>                      
        <input type="hidden" id="ror" value=""><br>                
    <!-- DATOS DEL REGISTRO SELECCIONADO-->
