...
-- CALL SP_SEGUIR_PROFESIONAL('13661574','fjcalderon@uc.cl');
-- SELECT * FROM PROFESIONAL_SEGUIDOR


DROP PROCEDURE IF EXISTS bodyflex.SP_SEGUIR_PROFESIONAL;
CREATE PROCEDURE bodyflex.`SP_SEGUIR_PROFESIONAL`(
                                                    IN rut VARCHAR(20),
                                                    IN ma VARCHAR(100)
                                                   )
BEGIN
