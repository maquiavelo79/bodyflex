...
-- CALL SP_PROFESIONAL_ADD_CARRITO('9386703','482v425q6ofr79enp27na39ii0','9386703','10','1000','1');
-- CALL SP_PROFESIONAL_ADD_CARRITO('9386703','482v425q6ofr79enp27na39ii0','9386703','10','1000','2');
-- CALL SP_PROFESIONAL_ADD_CARRITO('9386703','482v425q6ofr79enp27na39ii0','9386703','10','1000','3');

-- CALL SP_PROFESIONAL_ADD_CARRITO('9386703','482v425q6ofr79enp27na39ii0','9386703','4','1000','1');
-- CALL SP_PROFESIONAL_ADD_CARRITO('9386703','482v425q6ofr79enp27na39ii0','9386703','4','1000','3');
-- CALL SP_PROFESIONAL_ADD_CARRITO('9386703','482v425q6ofr79enp27na39ii0','9386703','4','1000','6');

-- select * from CARRO_DETALLE
-- select * from CARRO

DROP PROCEDURE IF EXISTS bodyflex.SP_PROFESIONAL_ADD_CARRITO;
CREATE PROCEDURE bodyflex.`SP_PROFESIONAL_ADD_CARRITO`( 
...
DECLARE EXIT HANDLER FOR SQLEXCEPTION SELECT '99';
    ...
    IF NOT EXISTS(SELECT * FROM CARRO WHERE caSesion=sesion) THEN
      ...
      , CONCAT('$',REPLACE(FORMAT(prePro ,0),',','.')) AS SUBTOT
    ...
    ELSE -- EL REGISTRO EXISTE  
      ...
      , CONCAT('$',REPLACE(FORMAT(prePro,0),',','.')) AS PREPRO
      , CONCAT('$',REPLACE(FORMAT(@TBRUTO ,0),',','.')) AS SUBTOT
      , (SELECT PROPNOM FROM PROFESIONAL_PRODUCTO WHERE PROPID=codPro) AS NOMPRO;    
