...
-- CALL SP_CONSULTA_PUBLICACION_RSM('0',0,'0','Cómo prepararte para una Spartan Race?','','','');
-- CALL SP_CONSULTA_PUBLICACION_RSM('0','0','0','','catx','etiy','refz','tit1','cat1','eti1','ref1','pro1');

-- select * from PUBLICACION_BUSQUEDA
