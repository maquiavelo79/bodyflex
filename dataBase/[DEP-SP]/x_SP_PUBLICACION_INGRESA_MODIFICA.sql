...
-- CALL SP_PUBLICACION_INGRESA_MODIFICA('9386703','0','TITULO1','PUBLICACION1','111111111','BAJADA1','ARTICULO');
-- CALL SP_PUBLICACION_INGRESA_MODIFICA('9386703','44','TITULO1','PUBLICACION1','111111111','BAJADA1','ARTICULO');
...
DROP PROCEDURE IF EXISTS bodyflex.SP_PUBLICACION_INGRESA_MODIFICA;
CREATE PROCEDURE bodyflex.`SP_PUBLICACION_INGRESA_MODIFICA`( 
                                                                IN rut VARCHAR(20)
                                                              , IN id VARCHAR(20)
                                                              , IN tit VARCHAR(100)
                                                              , IN pu VARCHAR(3000)
