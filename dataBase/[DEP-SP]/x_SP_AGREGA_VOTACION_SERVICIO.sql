...
-- CALL SP_AGREGA_VOTACION_SERVICIO('49', 'etjtivk24auuq8t58t1ru1tnv6', 1, 0);
-- CALL SP_AGREGA_VOTACION_SERVICIO('49', 'etjtivk24auuq8t58t1ru1tnv6', 0, 1);
-- CALL SP_AGREGA_VOTACION_SERVICIO('49', 'etjtivk24auuq8t58t1ru1tnv6', 0, 0);
-- CALL SP_AGREGA_VOTACION_SERVICIO('49', 'etjtivk24auuq8t58t1ru1tnv6', 1, 1);
-- SELECT * FROM SERVICIO_VOTACION
-- SELECT * FROM SERVICIO


DROP PROCEDURE IF EXISTS bodyflex.SP_AGREGA_VOTACION_SERVICIO;
CREATE PROCEDURE bodyflex.`SP_AGREGA_VOTACION_SERVICIO`( 
                                                    IN id VARCHAR(30)
                                                  , IN se VARCHAR(30)
