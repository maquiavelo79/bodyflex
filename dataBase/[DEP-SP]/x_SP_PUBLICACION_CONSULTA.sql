...
-- CALL SP_PUBLICACION_CONSULTA('9386703',1,'62'); 
-- CALL SP_PUBLICACION_CONSULTA('9386703',2,'62'); 

-- CALL SP_PUBLICACION_CONSULTA('9386703',1,'52'); 
-- CALL SP_PUBLICACION_CONSULTA('9386703',2,'52'); 

-- CALL SP_PUBLICACION_CONSULTA('9386703',1,'42'); 
-- CALL SP_PUBLICACION_CONSULTA('9386703',2,'42'); 

-- SELECT * FROM PUBLICACION

DROP PROCEDURE IF EXISTS bodyflex.SP_PUBLICACION_CONSULTA;
CREATE PROCEDURE bodyflex.`SP_PUBLICACION_CONSULTA`(
                                                    IN rut VARCHAR(10)
                                                    , IN sw INTEGER
