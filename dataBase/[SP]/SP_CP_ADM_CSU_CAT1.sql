  ...
  -- CANTIDAD DE PRODUCTOS
    ...
    IF(@CANT)>0 THEN
      ...
      WHILE CONT<PAG DO
        ...
        SET id = (SELECT PCP1_ID FROM TMP_Pag1 ORDER BY PCP1_ID DESC LIMIT 1); -- último paginación
        SET pr = (SELECT PCP1_ID FROM TMP_Pag1 ORDER BY PCP1_ID ASC LIMIT 1); -- primero paginación
