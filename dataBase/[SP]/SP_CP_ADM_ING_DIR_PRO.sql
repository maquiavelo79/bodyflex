-- CALL SP_CP_ADM_ING_DIR_PRO('9386703','0','TITULO1','PUBLICACION1','111111111','BAJADA1','ARTICULO');
-- CALL SP_CP_ADM_ING_DIR_PRO('9386703','44','TITULO1','PUBLICACION1','111111111','BAJADA1','ARTICULO');
...
DROP PROCEDURE IF EXISTS bodyflex.SP_CP_ADM_ING_DIR_PRO;
CREATE PROCEDURE bodyflex.`SP_CP_ADM_ING_DIR_PRO`( 
                                                    IN vIdPos VARCHAR(10)
                                                    , IN vId VARCHAR(20)
                                                    , IN vReg VARCHAR(50)
                                                    , IN vPro VARCHAR(50)
                                                    , IN vCom VARCHAR(50)
...
SET codErr=0;
    ...
    IF (SELECT COUNT(*) FROM DIRECCION WHERE DCOD=vId)=0 THEN
      ...
      UPDATE POSTULACION SET POSEST=9 WHERE POSID=vIdPos;  
