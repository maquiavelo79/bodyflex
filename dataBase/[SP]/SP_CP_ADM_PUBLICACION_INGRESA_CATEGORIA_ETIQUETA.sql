...
DROP PROCEDURE IF EXISTS bodyflex.SP_CP_ADM_PUBLICACION_INGRESA_CATEGORIA_ETIQUETA;
CREATE PROCEDURE bodyflex.`SP_CP_ADM_PUBLICACION_INGRESA_CATEGORIA_ETIQUETA`( 
                                                                IN rut VARCHAR(20)
                                                              , IN cat VARCHAR(50)
                                                              , OUT codErr INTEGER
                                                            )
