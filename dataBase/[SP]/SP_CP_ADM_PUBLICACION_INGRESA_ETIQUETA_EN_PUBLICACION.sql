...
-- CALL SP_CP_ADM_PUBLICACION_INGRESA_ETIQUETA_EN_PUBLICACION('23','CATEGORIA1','ETI1_CAT1');
-- CALL SP_CP_ADM_PUBLICACION_INGRESA_ETIQUETA_EN_PUBLICACION('23','CATEGORIA1','ETI1_CAT1');
...
DROP PROCEDURE IF EXISTS bodyflex.SP_CP_ADM_PUBLICACION_INGRESA_ETIQUETA_EN_PUBLICACION;
CREATE PROCEDURE bodyflex.`SP_CP_ADM_PUBLICACION_INGRESA_ETIQUETA_EN_PUBLICACION`( 
                                                                IN id  VARCHAR(10)
                                                              , IN cat VARCHAR(50)
                                                              , IN eti VARCHAR(50)
                                                              , OUT codErr INTEGER
