...
DROP PROCEDURE IF EXISTS bodyflex.SP_CP_ADM_PUBLICACION_OBTIENE_ETIQUETAS_X_CATEGORIA;
CREATE PROCEDURE bodyflex.`SP_CP_ADM_PUBLICACION_OBTIENE_ETIQUETAS_X_CATEGORIA`(
                                                  IN categ VARCHAR(50)
                                                  , OUT codErr INTEGER
                                                )
BEGIN
