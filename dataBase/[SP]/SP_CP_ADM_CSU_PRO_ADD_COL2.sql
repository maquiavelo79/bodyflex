...
CALL SP_CP_ADM_CSU_PRO_ADD_COL2(7, @codErr);
SELECT @codErr;

-- SELECT * FROM PRODUCTO
-- SELECT * FROM PARAMETROS

DROP PROCEDURE IF EXISTS bodyflex.SP_CP_ADM_CSU_PRO_ADD_COL2;
CREATE PROCEDURE bodyflex.`SP_CP_ADM_CSU_PRO_ADD_COL2`(
                                                      IN id VARCHAR(10)      
                                                      , OUT codErr INTEGER
                                                      )
BEGIN
