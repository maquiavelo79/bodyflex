...
DROP PROCEDURE IF EXISTS bodyflex.SP_CP_ADM_PROFESIONAL_PRODUCTO_INGRESA_MODIFICA_CONTENIDO;
CREATE PROCEDURE bodyflex.`SP_CP_ADM_PROFESIONAL_PRODUCTO_INGRESA_MODIFICA_CONTENIDO`( 
                                                    IN proId VARCHAR(10) ,
