/*
CALL SP_CP_PRO_MENSAJE_INGRESA_RESPUESTA('9386703','0','R','26','RESPUESTA RESPUESTA RESPUESTA ','ASUNTO: [28] hggfhgfhgfh','','usr','pro@bo.cl');
*/
-- SELECT * FROM profesional_mensaje

DROP PROCEDURE IF EXISTS bodyflex.SP_CP_PRO_MENSAJE_INGRESA_RESPUESTA;
CREATE PROCEDURE bodyflex.`SP_CP_PRO_MENSAJE_INGRESA_RESPUESTA`(
