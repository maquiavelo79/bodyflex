...
-- CALL SP_CP_PRO_PRODUCTO_ELIMINA_CONTENIDO(33,8);

DROP PROCEDURE IF EXISTS bodyflex.SP_CP_PRO_PRODUCTO_ELIMINA_CONTENIDO;
CREATE PROCEDURE bodyflex.`SP_CP_PRO_PRODUCTO_ELIMINA_CONTENIDO`(
                                                            IN vpId VARCHAR(20),
                                                            IN conId INTEGER,
                                                            OUT codErr INTEGER
                                                          )
