...
DROP PROCEDURE IF EXISTS delta.SP_CP_PRO_PUBLICACION_CONSULTA_REFERENCIAS_ASOCIADAS;
CREATE PROCEDURE delta.`SP_CP_PRO_PUBLICACION_CONSULTA_REFERENCIAS_ASOCIADAS`(
                                                                      IN idPub VARCHAR(20)
                                                                      , OUT codErr INTEGER
                                                                    )
BEGIN
