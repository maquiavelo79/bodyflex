...
-- [PRIMERA LLAMADA]
-- CALL SP_CP_PRO_MENSAJE_SET_COMO_LEIDO(10,'usr@bo.cl'); 
-- SELECT * FROM PROFESIONAL_MENSAJE;

DROP PROCEDURE IF EXISTS bodyflex.SP_CP_PRO_MENSAJE_SET_COMO_LEIDO;
CREATE PROCEDURE bodyflex.`SP_CP_PRO_MENSAJE_SET_COMO_LEIDO`(
                                                    IN id VARCHAR(20)
