...
-- CALL SP_CP_ADM_PUBLICACION_INGRESA_MODIFICA_CONTENIDO('69', 'IMAGEN', '0BwscgrEmxbyLb3NIYk1PSDFCMEU', 0);
-- CALL SP_CP_ADM_PUBLICACION_INGRESA_MODIFICA_CONTENIDO('69', 'IMAGEN', '0BwscgrEmxbyLZTVONVU2SmVQTGs', 0);
-- CALL SP_CP_ADM_PUBLICACION_INGRESA_MODIFICA_CONTENIDO('69', 'IMAGEN', '0BwscgrEmxbyLbklEMWZBZDdkUUU', 0);
...
DROP PROCEDURE IF EXISTS bodyflex.SP_CP_ADM_PUBLICACION_INGRESA_MODIFICA_CONTENIDO;
CREATE PROCEDURE bodyflex.`SP_CP_ADM_PUBLICACION_INGRESA_MODIFICA_CONTENIDO`( 
                                                    IN pId VARCHAR(100) ,
