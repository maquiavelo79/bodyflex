...
-- CALL SP_CP_PRO_EXPERIENCIA_INGRESA_MODIFICA('9386703','0','CARGO1','INST1','01/01/2000','31/01/2000',1,'DESCRIPCION1');
-- CALL SP_CP_PRO_EXPERIENCIA_INGRESA_MODIFICA('9386703','0','CARGO2','INST2','01/01/2000','31/01/2003',2,'DESCRIPCION2');
-- CALL SP_CP_PRO_EXPERIENCIA_INGRESA_MODIFICA('9386703','0','CARGO3','INST3','01/01/2000','03/03/2007',3,'DESCRIPCION3');

-- CALL SP_CP_PRO_EXPERIENCIA_INGRESA_MODIFICA('9386703','9','CARGO4','INST4','01/01/2010','31/07/2015',4,'DESCRIPCION12345');
-- CALL SP_CP_PRO_EXPERIENCIA_INGRESA_MODIFICA('9386703','2','CARGO5','INST5','01/01/1990','20/09/2003',5,'DESCRIPCION5');
-- CALL SP_CP_PRO_EXPERIENCIA_INGRESA_MODIFICA('9386703','3','CARGO6','INST6','01/01/2000','03/03/2007',6,'DESCRIPCION6');
   
-- SELECT * FROM PROFESIONAL
-- SELECT * FROM CURRICULUM
-- SELECT * FROM EXPERIENCIA;

DROP PROCEDURE IF EXISTS bodyflex.SP_CP_PRO_EXPERIENCIA_INGRESA_MODIFICA;
CREATE PROCEDURE bodyflex.`SP_CP_PRO_EXPERIENCIA_INGRESA_MODIFICA`( 
                                                                          IN rut VARCHAR(20)
                                                                        , IN id VARCHAR(20)
                                                                        , IN car VARCHAR(100)
                                                                        , IN ins VARCHAR(100)
