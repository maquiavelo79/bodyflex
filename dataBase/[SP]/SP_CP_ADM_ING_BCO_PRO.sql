-- CALL SP_CP_ADM_ING_BCO_PRO('9386703','0','TITULO1','PUBLICACION1','111111111','BAJADA1','ARTICULO');
-- CALL SP_CP_ADM_ING_BCO_PRO('9386703','44','TITULO1','PUBLICACION1','111111111','BAJADA1','ARTICULO');
...
DROP PROCEDURE IF EXISTS bodyflex.SP_CP_ADM_ING_BCO_PRO;
CREATE PROCEDURE bodyflex.`SP_CP_ADM_ING_BCO_PRO`( 
                                                    IN vId VARCHAR(20)
                                                  , IN vBco VARCHAR(50)
                                                  , IN vTip VARCHAR(50)
                                                  , IN vNum VARCHAR(50)
