...
DROP PROCEDURE IF EXISTS bodyflex.SP_CP_ADM_PROFESIONAL_PRODUCTO_ELIMINA_CONTENIDO;
CREATE PROCEDURE bodyflex.`SP_CP_ADM_PROFESIONAL_PRODUCTO_ELIMINA_CONTENIDO`(
                                                            IN puId VARCHAR(20),
                                                            IN conId INTEGER,
                                                            OUT codErr INTEGER
                                                          )
...
SET codErr=0;
  ...
  WHERE proPID=puId AND pco_id=conId;
  SELECT 1;     
