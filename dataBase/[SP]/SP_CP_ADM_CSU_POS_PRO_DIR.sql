...
CALL SP_CP_ADM_CSU_POS_PRO_DIR(1,@codErr,@estado,@rut,@nombres,@apellidos);
SELECT @codErr,@estado,@rut,@nombres,@apellidos;

CALL SP_CP_ADM_CSU_POS_PRO_DIR(12,@codErr,@estado,@rut,@nombres,@apellidos);
SELECT @codErr,@estado,@rut,@nombres,@apellidos;

DROP PROCEDURE IF EXISTS bodyflex.SP_CP_ADM_CSU_POS_PRO_DIR;
CREATE PROCEDURE bodyflex.`SP_CP_ADM_CSU_POS_PRO_DIR`(
                                                        IN id VARCHAR(20)
                                                        , OUT codErr INTEGER
