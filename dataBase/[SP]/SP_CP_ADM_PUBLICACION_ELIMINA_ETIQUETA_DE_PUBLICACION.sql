...
DROP PROCEDURE IF EXISTS bodyflex.SP_CP_ADM_PUBLICACION_ELIMINA_ETIQUETA_DE_PUBLICACION;
CREATE PROCEDURE bodyflex.`SP_CP_ADM_PUBLICACION_ELIMINA_ETIQUETA_DE_PUBLICACION`( 
                                                                IN id VARCHAR(50)
                                                                , IN cat VARCHAR(50)
                                                                , IN eti VARCHAR(50)
                                                                , OUT codErr INTEGER
