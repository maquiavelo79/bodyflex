-- [PRIMERA LLAMADA]
-- CALL SP_MENSAJE_PROFESIONAL_CONSULTA('pro@bo.cl',0,'0');
-- CALL SP_MENSAJE_PROFESIONAL_CONSULTA('usr@bo.cl',0,'0');
-- SELECT * FROM PROFESIONAL_MENSAJE

DROP PROCEDURE IF EXISTS bodyflex.SP_CP_ADM_MENSAJE_PROFESIONAL_CONSULTA;
CREATE PROCEDURE bodyflex.`SP_CP_ADM_MENSAJE_PROFESIONAL_CONSULTA`(
                                                    IN email VARCHAR(50)
                                                    , IN sw INTEGER
