...
-- [PRIMERA LLAMADA]
-- CALL SP_CP_PRO_MENSAJE_OBTIENE_DETALLE(32); 
-- SELECT * FROM PROFESIONAL_MENSAJE;

DROP PROCEDURE IF EXISTS bodyflex.SP_CP_PRO_MENSAJE_OBTIENE_DETALLE;
CREATE PROCEDURE bodyflex.`SP_CP_PRO_MENSAJE_OBTIENE_DETALLE`(
                                                    IN id VARCHAR(20)
                                                    , OUT codErr INTEGER
                                                  )
BEGIN
