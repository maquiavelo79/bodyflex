...
-- CALL SP_WPRO_AGREGA_VOTACION_PROFESIONAL('109', 'fjcalderon@uc.cl', 1, 0);
-- CALL SP_WPRO_AGREGA_VOTACION_PROFESIONAL('109', 'fjcalderon@uc.cl', 0, 1);
-- SELECT * FROM PUBLICACION_VOTACION


DROP PROCEDURE IF EXISTS bodyflex.SP_WPRO_AGREGA_VOTACION_PROFESIONAL;
CREATE PROCEDURE bodyflex.`SP_WPRO_AGREGA_VOTACION_PROFESIONAL`( 
                                                    IN rut VARCHAR(20)
                                                  , IN em VARCHAR(100)
