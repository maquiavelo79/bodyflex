-- CALL SP_CP_PRO_CONSULTA_CATEGORIAS_PRODUCTOS(1,0,@codErr);
-- SELECT @codErr;

-- CALL SP_CP_PRO_CONSULTA_CATEGORIAS_PRODUCTOS(2,1,@codErr);
-- CALL SP_CP_PRO_CONSULTA_CATEGORIAS_PRODUCTOS(2,2,@codErr);
-- CALL SP_CP_PRO_CONSULTA_CATEGORIAS_PRODUCTOS(2,3,@codErr);
-- CALL SP_CP_PRO_CONSULTA_CATEGORIAS_PRODUCTOS(3,4,@codErr);
-- &#209;
...
DROP PROCEDURE IF EXISTS bodyflex.SP_CP_PRO_CONSULTA_CATEGORIAS_PRODUCTOS;
CREATE PROCEDURE bodyflex.`SP_CP_PRO_CONSULTA_CATEGORIAS_PRODUCTOS`(
                                                    IN nivelCat INTEGER
                                                    , IN nivelCod INTEGER
                                                    , OUT codErr INTEGER
                                                 )
