...
-- CALL SP_CP_PRO_CSU_POS_PRO_CTA(1,@codErr,@estado,@rut,@nombres,@apellidos);
-- SELECT @codErr,@estado,@rut,@nombres,@apellidos;

-- CALL SP_CP_PRO_CSU_POS_PRO_CTA(12,@codErr,@estado,@rut,@nombres,@apellidos);
-- SELECT @codErr,@estado,@rut,@nombres,@apellidos;

DROP PROCEDURE IF EXISTS bodyflex.SP_CP_PRO_CSU_POS_PRO_CTA;
CREATE PROCEDURE bodyflex.`SP_CP_PRO_CSU_POS_PRO_CTA`(
                                                        IN vId VARCHAR(20)
                                                        , OUT codErr INTEGER
