    ...
    <ul class="nav navbar-nav">
        ...
        <li class="dropdown megamenu-fullwidth">
            ...
            <ul class="dropdown-menu">
                <li id="coleccionesMenu" class="megamenu-content "></li>
            </ul>
        </li>
        ...
        <li class="dropdown megamenu-fullwidth">
            ...
            <ul class="dropdown-menu">
                <li id="coleccionMnuColCat" class="megamenu-content ProductDetailsList"></li>    
            </ul>    
        </li>
        ...
        <li class="dropdown megamenu-fullwidth">
            ...
            <ul class="dropdown-menu">
                <li class="megamenu-content ProductDetailsList">
                    <h3 class="promo-1 no-margin hidden-xs">60 + HTML PAGES || AVAILABLE ONLY AT WRAP BOOTSTRAP </h3>
