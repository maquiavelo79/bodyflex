                ...
                while ($r = $stmt->fetch(PDO::FETCH_NUM)):
                    ...
                    $sTr.='<div class="swiper-slide slide-4x">';
                        $sTr.='<div class="box-4in c">';
                            $sTr.='<div class="box-slider-content" id="'.$pIdP1.'" url="'.$pURL1.'" tipo="PRODUCTO"><a href="#" class="box-img">'; 
                        ...
                        $sTr.='</div>';
                        $sTr.='<div class="box-4in c">';
                            $sTr.='<div class="box-slider-content" id="'.$pIdP2.'" url="'.$pURL2.'" tipo="PRODUCTO"><a href="#" class="box-img">'; 
                        ...
                        $sTr.='</div>';
                        $sTr.='<div class="box-4in c">';
                            $sTr.='<div class="box-slider-content" id="'.$pIdP3.'" url="'.$pURL3.'" tipo="PRODUCTO"><a href="#" class="box-img">'; 
                        ...
                        $sTr.='<div class="box-4in d">';
                            $sTr.='<div class="box-slider-content" id="'.$pIdP4.'" url="'.$pURL4.'" tipo="PRODUCTO">';
                                $sTr.='<a class="box-img">';
