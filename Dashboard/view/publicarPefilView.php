...
<head>
    <!-- Basic Page Needs =========== -->
    <meta charset="utf-8">
    <title>Bodyflex - Publicar Perfil</title>
    <meta name="description" content="">
    <meta name="author" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    
    <?php include("../modulos/proFavicon.php"); ?>
    <?php include("../modulos/proEstilos.php"); ?>
    <?php include("../modulos/proJavaScript.php"); ?>   
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success:  function (xml){
                    ...
                    //alert('productoProGetProCartModel ' + xml);
            ...
            $.ajax({
                ...
                success:  function (xml){
                    ...
                    //alert('perfilProGetProCartModel1 ' + xml);
