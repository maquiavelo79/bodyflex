...
<!--                            <div class="box-header" data-original-title>  class="box-header" data-original-title 
                                <h2 id="h2Inf">
                                    <i class="halflings-icon edit"></i>
                                    <span class="break"></span>Seleccione servicio &nbsp;&nbsp;
                                    <span class="msg" id="queEsUnServicio">  onclick="servicios();" 
                                        <i><u>¿QUE ES UN SERVICIO?</u></i>
                                    </span>&nbsp;
                                    <span class="msg" id="faltanServicios">  onclick="faltanServicios();"
                                        <i><u>¿FALTAN SERVICIOS?</u></i>
                                    </span>
                                </h2>
                                ...
                                <div class="box span12">
                                    <div class="box-header" data-original-title>
                                        <h2 style="font-size: 14px; font-family: Century Gothic,CenturyGothic,AppleGothic,sans-serif; font-weight: bold; color: black;">
                                            ...
                                            &nbsp;&nbsp; 
                                            <span onclick="queEsPresentacion();" style="cursor: pointer; color: blue; font-size: 14px; font-family: Century Gothic,CenturyGothic,AppleGothic,sans-serif; font-weight: bold;">
                                                <i><u>¿QUE ES LA PRESENTACIÓN?</u>
                                                </i>
                                            </span>
                                        </h2>
                                    </div>		
                            ...
                            <div class="box-header" data-original-title>
                                <h2 style="font-size: 14px; font-family: Century Gothic,CenturyGothic,AppleGothic,sans-serif; font-weight: bold; color: black;">
                                    ...
                                    &nbsp;&nbsp; 
                                    <span onclick="queEsPresentacion();" style="cursor: pointer; color: blue; font-size: 14px; font-family: Century Gothic,CenturyGothic,AppleGothic,sans-serif; font-weight: bold;">
                                        <i><u>¿QUE ES LA PRESENTACIÓN?</u></i>
                                    </span>
                                </h2>
                                </div>
                            <br>
