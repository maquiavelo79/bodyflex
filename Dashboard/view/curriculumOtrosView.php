...
<head>
	...
	<!-- Basic Page Needs================ -->
            <meta charset="utf-8">
            <title>Bodyflex - [PRO] Otros</title>
...
<body>
                        ...
                        <div class="box span12">
                                <div class="box-header" data-original-title>
                                    <h2 style="font-size: 14px; font-family: Century Gothic,CenturyGothic,AppleGothic,sans-serif; font-weight: bold; color: black;">
                                        ...
                                        <span class="break"></span>Otras Participaciones
                                        &nbsp;&nbsp; <span onclick="otras();" style="cursor: pointer; color: blue; font-size: 14px; font-family: Century Gothic,CenturyGothic,AppleGothic,sans-serif; font-weight: bold;"><u>¿POR QUÉ ES IMPORTANTE QUE INGRESES OTRAS PARTICIPACINES?</u></span>
                                    </h2>
                                </div>
                                <br>
                                <div class="box-content control-group">
                                    <form class="form-horizontal" id="formEstudios">
                                        <fieldset>
                                            ...
                                            <div id="conOtId" style="margin-top: 8px;">
                                                <label id="lblOtId" class="control-label" for="appendedInput"><b>Identificador</b></label>
                                                <div class="controls">
                                                    <div class="input-append">
                                                        <input style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; text-align: center; color: black;" id="txtOtId" size="30" type="text" maxlength="10" disabled>
                                                    </div>
                                                    <span class="help-inline"></span>
                                                </div>
                                            </div> 
                                            <div id="conOtNom" style="margin-top: 8px;">
                                                <label id="lblOtNom" class="control-label" for="appendedInput"><b>Nombre</b></label>
                                                <div class="controls">
                                                    <div class="input-append">
                                                        <input style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; text-align: center; color: black; width: 500px;" id="txtOtNom" size="30" type="text" maxlength="100">
                                                    </div>
                                                    <span class="help-inline">Ej: 11º Congreso Internacional de Ciencias del Deporte y la Educación Física.</span>
                                                </div>
                                            </div>
                                            <div id="conOtTip" style="margin-top: 8px;">
                                                <label id="lblOtTip" class="control-label" for="appendedInput"><b>Tipo</b></label>
                                                <div class="controls">					
                                                    <select id="cmbOtTip" style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; text-align: center; color: black; width: 300px;">
                                            ...
                                            <!-- FECHA DESDE -->                                            
                                            <div id="conOtFec" style="margin-top: 8px;">
                                                <label  class="control-label" for="fecha"><b>Fecha</b></label>
                                                <div class="controls">
                                                    <input style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; text-align: center; color: black;" type="text" id="date" name="datepicker">
                                                </div>    
                                            </div>
                                            
                                            <!-- POSICIÓN -->
                                            <div id="conOtFli" style="margin-top: 8px;">
                                                <label id="lblOtFli"  class="control-label" for="appendedInput"><b>Posici&oacute;n</b></label>
                                                <div class="controls">
                                                    <div class="input-append">
                                                    ...
                                                    <span class="help-inline">
                                                        Posición visualización en sitio.
                                                    </span>
                                                </div>
                                            </div>  
                                            
                                            <div id="conOtDes" style="margin-top: 8px;">
                                                <label id="lbltxt" class="control-label" for="textarea2"><b>Descripción</b></label>
                                                <div class="controls">
                                                    <textarea style="background-color: whitesmoke; box-shadow: 0 0 2px black; margin: 0px 0px 0px 0px; font-weight: bold; color: black; text-align: center; color: black;" class="cleditor" id="txtOtDes" name="textarea2" rows="5"></textarea>
                                                </div>
                    ...
                    <div class="row-fluid sortable">		
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2 style="font-size: 14px; font-family: Century Gothic,CenturyGothic,AppleGothic,sans-serif; font-weight: bold; color: black;">
                                    <i class="halflings-icon edit"></i>
                                    <span class="break"></span>Otras Participaciones ingresados
                                </h2>
                            </div>
                            <div class="box-content" id="conTabla"><!--contenedor de tabla -->
                                <table id="tblOtros" class="table table-striped table-bordered bootstrap-datatable">
                                    <thead>
                                        <tr>
                                            <th>Id</th>
                                            <th>Nombre</th>
    ...
    <script src="../controller/curriculumOtrosController.js"></script>
    <!-- end: JavaScript-->
