...
jQuery(document).ready(function() {
    ...
    $.ajax({
            url: URLprotocol+"//"+URLdomain+"/bodyflex/Dashboard/model/regProDirCsuRegModel.php",
            type:  'post',
            datetype: 'xml',
            async: true,
    ...
    $.ajax({
            data:  parametros,
            url: URLprotocol+"//"+URLdomain+"/bodyflex/Dashboard/model/regProDirCsuModel.php",
            type:  'post',
            datetype: 'xml',
            async: true,
        beforeSend: function(){
    ...
    $("#cmbRegion").change(function(){
        ...
        if($('#cmbRegion').val()!='(SELECCIONE)'){        
            ...
            $.ajax({
                data:  parametros,
                url: URLprotocol+"//"+URLdomain+"/bodyflex/Dashboard/model/regProDirCsuProvModel.php",
                type:  'post',
                datetype: 'xml',
                async: true,
                success:  function (xml){
    ...
    $("#cmbProvincia").change(function(){
        ...
        if($('#cmbProvincia').val()!='(SELECCIONE)'){   
            ...
            $.ajax({
                data:  parametros,
                url: URLprotocol+"//"+URLdomain+"/bodyflex/Dashboard/model/regProDirCsuComModel.php",
                type:  'post',
                datetype: 'xml',
                async: true,
                success:  function (xml){
    ...
    $('#btnGuardar').click(function(){
        ...
        //alert($('#txtCal').val() + ' ' + $('#txtNum').val() + ' ' + $('#cmbRegion').val() + ' ' + 'Chile');

        $.ajax({
                data:  parametros,
                url: URLprotocol+"//"+URLdomain+"/bodyflex/Dashboard/model/regProDirIngModModel.php",
                type:  'post',
                datetype: 'xml',
                async: true,
            beforeSend: function(){
    ...
    $('#btnEliminar').click(function(){
        ...
        if(id.length>0){
            ...
            strModal+='<div class="modal-body" id="modalBody">';
                strModal+='<p>¿Desea eliminar dirección con identificador ' + '<b>' + id + '</b>?' + '</p>';
            strModal+='</div>';
    ...
    var strLoad='<div id="espera2" class="modal-body"></div>';
        ...
        $.ajax({
                data:  parametros,
                url: URLprotocol+"//"+URLdomain+"/bodyflex/Dashboard/model/regProDirEliModel.php",
                type:  'post',
                datetype: 'xml',
                async: true,
            beforeSend: function(){
...
function asociarCoordenadas(idDir){  
    ...
    var rsp=0;
        ...
        $.ajax({
                data:  parametros,
                url: URLprotocol+"//"+URLdomain+"/bodyflex/Dashboard/model/regProDirIngCorModel.php",
                type:  'post',
                datetype: 'xml',
                async: false,
            beforeSend: function(){
