...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.ajax({
            data:  parametros,
            url: URLprotocol+"//"+URLdomain+"/bodyflex/cv/model/curGetOtrModel.php",
            type:  'post',
            async:  false,
            datetype: 'xml',
            success:  function (xml){
                ...
                switch(codErr){
                    ...
                    default:
                        ...
                        var otros = xmlDoc.getElementsByTagName('DATOS')[0].childNodes[0].nodeValue;
...
<h2 id="ribbon" class="sectionHead">Otras Experiencias</h2>
