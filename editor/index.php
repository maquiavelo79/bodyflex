...
<head>
	...
	<!-- Basic Page Needs================ -->
            <meta charset="utf-8">
            <title>Bodyflex - CPANEL [EDI]</title>
...
<body>
        <!-- start: Header -->
	<?php include("../editor/modulos/header.php"); ?>
	<!-- start: Header -->
        <div class="container-fluid-full">
            <div class="row-fluid">
                <?php include("../editor/modulos/menu.php"); ?>
                <noscript>
                ...
                <div id="content" class="span10">	
                    <?php include("../editor/modulos/navegacion.php"); ?>
                    <?php include("../editor/modulos/indicadoresRectangular4.php"); ?>	
                    <?php include("../editor/modulos/histogramas2.php"); ?>    
                    <?php include("../editor/modulos/indicadoresCirculares6.php"); ?>    
                    <?php include("../editor/modulos/histogramas3.php"); ?>  
                    <?php include("../editor/modulos/eventos3.php"); ?>	
                    <?php include("../editor/modulos/indicadoresCuadrados6.php"); ?>                            
                </div>
            </div><!--/#content.span10-->
        </div><!--/fluid-row-->
	...
	<!-- start: JavaScript-->
            ...
            <?php include("../editor/modulos/javaScript.php"); ?>
	<!-- end: JavaScript-->
